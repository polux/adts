...
$$.init_autogenerated_anon11 = {"": "Closure;box_0",
  call$1: function($$event) {
    $.copyMethod = this.box_0.__e3_4.get$checked();
  },
  $isFunction: true
};
...
$$._generate_generateConstructorClass = {"": "Closure;config_4,classMap_5,overriden_6,write_7,writeLn_8,generateMatchMethodPrefix_9",
  call$2: function(def, cons) {
    ...
    if (t3.get$copyMethod() === true && $.isEmpty(cons.get$parameters()) !== true && this.overriden_6.call$2(cons.get$name(), "copy") !== true) {
      t1.call$1("  " + $.S(cons.get$name()) + typeArgs + " copy({" + typedParams + "}) {");
...
$.generated = function() {
  ...
  if (parseResult.get$isSuccess() === true) {
    ...
    t6 = $.toStringMethod;
    t7 = $.visitor;
    config = $.Configuration$(t3, t4, false, t5, true, t1, true, true, t2, $.matchMethod, false, true, t6, t7);
