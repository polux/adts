...
$$.Parser = {"":"Object;_run",
 ...
 skipManyUntil$1: function(end) {
  return $.Parser$(new $.Parser_skipManyUntil_anon(end, this));
},
 ...
 sepBy1$1: function(sep) {
  return this.operator$shr$1(new $.Parser_sepBy1_anon(this, sep));
},
...
$$.init_autogenerated_anon24 = {"":"Closure;box_0",
 call$1: function(__e) {
  var t1, t2;
  t1 = $.generated();
  t2 = this.box_0;
  t2.__binding8_9 = $.updateBinding(t1, t2.__binding8_9, __e.get$newValue());
}
};
...
$$._generate_generateConstructorClass = {"":"Closure;config_4,writeLn_3,write_2",
 call$2: function(def, cons) {
  ...
  if (t1) {
    ...
    this.write_2.call$1($.Strings_join(acc, ",\n"));
    t2.call$1(");");
    t2.call$1("  }");
  }
  t2.call$1("}");
...
$$._generate_generateSuperClass = {"":"Closure;config_6,writeLn_5",
 call$1: function(def) {
...
$$._generate_generateVisitorClass = {"":"Closure;writeLn_7",
 call$1: function(def) {
...
$$._generate_generateDefinition = {"":"Closure;generateConstructorClass_12,writeLn_11,generateSuperClass_10,config_9,generateVisitorClass_8",
 call$1: function(def) {
  var t1, t2, t3;
  this.generateSuperClass_10.call$1(def);
  t1 = this.writeLn_11;
  t1.call$1("");
  if (this.config_9.get$visitor() === true) {
    this.generateVisitorClass_8.call$1(def);
    t1.call$1("");
  }
  for (t2 = def.get$constructors(), t2 = $.getInterceptor$JSArray(t2).iterator$0(t2), t3 = this.generateConstructorClass_12; t2.get$hasNext() === true;) {
...
$$._generate_generateImports = {"":"Closure;writeLn_14,config_13",
 call$0: function() {
  var t1, written;
  t1 = this.config_13;
  if (t1.get$parser() === true) {
    this.writeLn_14.call$1("import 'package:parsers/parsers.dart' as parsers;");
    written = true;
  } else
    written = false;
...
$$.Parser_sepBy1_anon = {"":"Closure;this_1,sep_0",
 call$1: function(x) {
  return $.gt(this.sep_0, this.this_1)._many$1(new $.Parser_sepBy1__anon(x));
}
};
...
$$.ParserAccumulator4_operator$xor___anon = {"":"Closure;f_5,x2_4,x1_3",
 call$1: function(x3) {
  return new $.ParserAccumulator4_operator$xor____anon(this.f_5, this.x2_4, this.x1_3, x3);
}
};

$$.ParserAccumulator4_operator$xor____anon = {"":"Closure;f_9,x2_8,x1_7,x3_6",
 call$1: function(x4) {
  return this.f_9.call$4(this.x1_7, this.x2_8, this.x3_6, x4);
}
};
...
$$.Parser_skipManyUntil_anon = {"":"Closure;end_1,this_0",
 call$2: function(s, pos) {
  var t1, t2, index, endRes, xRes;
  for (t1 = this.this_0, t2 = this.end_1, index = pos; true;) {
...
$.generated = function() {
  var parseResult, t1, t2, t3, t4, config;
  ...
  if (parseResult.get$isSuccess() === true) {
    ...
    t3 = $.asGetters;
    t4 = $.withMethod;
    config = $.Configuration$(t3, false, $.equality, true, t1, true, true, t2, true, false, true, $.toStringMethod, $.visitor, t4);
...
$.init_autogenerated = function() {
  var t1, _root, __stoppers2, __e9, t2, __listener__e0_input_1, __listener__e1_change_3, __listener__e2_change_4, __listener__e3_change_5, __listener__e4_change_6, __listener__e5_change_7, __listener__e6_change_8, __listener__e7_change_9;
  t1 = {};
  ...
  __e9 = _root.query$1("#__e-9");
  t1.__binding8_9 = $.Text_Text("");
  t2 = __e9.get$nodes();
  $.getInterceptor$JSArray(t2).add$1(t2, t1.__binding8_9);
  t2 = __e9.get$nodes();
  ...
  __stoppers2.push($.watchAndInvoke(new $.init_autogenerated_anon23(), new $.init_autogenerated_anon24(t1), null));
};
...
$._generate = function(config, buffer, defs) {
  ...
  t3 = new $._generate_generateDefinition(new $._generate_generateConstructorClass(config, t2, t1), t2, new $._generate_generateSuperClass(config, t2), config, new $._generate_generateVisitorClass(t2));
